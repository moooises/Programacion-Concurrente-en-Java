...
public class Pentagono extends Poligono{
	...
	public Pentagono(Punto p1, Punto p2,Punto p3,Punto p4,Punto p5){
		super(5);
		vertices= new Punto[5];
		vertices[1]= p1;
		vertices[2]= p2;
		vertices[3]= p3;
		vertices[4]= p4;
	...
	public double Perimetro(){
		...
		double e=Math.sqrt(Math.pow((vertices[5].y-vertices[5].x),2)+Math.pow((vertices[1].y-vertices[1].x),2));
		return a+b+c+d+e;
		
	}
	
	/**
	 * Indica si el pentagono es regular. 
